...
00000000: 23 20 2f 65 74 63 2f 70  72 6f 66 69 6c 65 3a 20  |# /etc/profile: |
00000010: 73 79 73 74 65 6d 2d 77  69 64 65 20 2e 70 72 6f  |system-wide .pro|
00000020: 66 69 6c 65 20 66 69 6c  65 20 66 6f 72 20 74 68  |file file for th|
00000030: 65 20 42 6f 75 72 6e 65  20 73 68 65 6c 6c 20 28  |e Bourne shell (|
00000040: 73 68 28 31 29 29 0a 23  20 61 6e 64 20 42 6f 75  |sh(1)).# and Bou|
00000050: 72 6e 65 20 63 6f 6d 70  61 74 69 62 6c 65 20 73  |rne compatible s|
00000060: 68 65 6c 6c 73 20 28 62  61 73 68 28 31 29 2c 20  |hells (bash(1), |
00000070: 6b 73 68 28 31 29 2c 20  61 73 68 28 31 29 2c 20  |ksh(1), ash(1), |
00000080: 2e 2e 2e 29 2e 0a 0a 69  66 20 5b 20 22 24 28 69  |...)...if [ "$(i|
00000090: 64 20 2d 75 29 22 20 2d  65 71 20 30 20 5d 3b 20  |d -u)" -eq 0 ]; |
...
```
...
00000000: 47 43 43 3a 20 28 44 65  62 69 61 6e 20 31 32 2e  |GCC: (Debian 12.|
00000010: 32 2e 30 2d 31 34 2b 64  65 62 31 32 75 31 29 20  |2.0-14+deb12u1) |
00000020: 31 32 2e 32 2e 30 00                              |12.2.0.|
```
